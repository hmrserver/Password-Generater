...
<form>
    <div class="form-group">
      <input type="number" class="form-control" id="length" required="required" placeholder="Enter Password Length" /><br>
...
</label><span class="badge badge-success" style="margin-top: 4px;position: absolute;">Recommended</span><br>
<label class="custom-control custom-checkbox">
...
<br>
<center><div id="status" style="overflow-wrap: break-word;"></div></center></div>
<div class="col-md-3"></div>
</div>
</div>
